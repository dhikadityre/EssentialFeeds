//
//  FeedViewIntegrationTests.swift
//  EssentialFeed
//
...
final class FeedViewIntegrationTests: XCTestCase {
    ...
    */
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        /// TODO: Perbaiki error untuk iOS 17
        ...
        loader.completeFeedLoadingWithError(at: 1) // Tambahkan case error dan pastikan loading indikator tidak ada
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected no loading indicator once loading is completes successfully")
    }
    ...
    private func makeVisible(_ sut: FeedViewController) {
        let window = UIWindow()
